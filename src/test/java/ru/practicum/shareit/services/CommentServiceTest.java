...
@SpringBootTest
@ContextConfiguration(classes = {CommentService.class, CommentMapper.class})
public class CommentServiceTest {
    ...
    void addComment() {
        ...
        CommentDto commentExpecterdDto1 = new CommentDto(1, "text1", "name1", time1);
        ...
        CommentDto actualComment = commentService.addComment(1,1, commentDto1);

        Assertions.assertEquals(commentExpecterdDto1, actualComment);
        ...
        Mockito.verify(commentStorage, Mockito.times(1)).save(any());

        Mockito.verify(commentMapper, Mockito.times(1)).toComment(any(), any(), any());
