...
public class ItemRequestMapperTest {
    ...
    void toItemRequestSimplifiedDto_200_Test() {
        ...
        assertEquals(itemRequestSimplified.getItems().get(0).getId(), itemRequestSimplifiedDto.getItems().get(0).getId());
        assertEquals(itemRequestSimplified.getItems().get(0).getName(), itemRequestSimplifiedDto.getItems().get(0).getName());
        assertEquals(itemRequestSimplified.getItems().get(0).getDescription(), itemRequestSimplifiedDto.getItems().get(0).getDescription());
        assertEquals(itemRequestSimplified.getItems().get(0).getRequestId(), itemRequestSimplifiedDto.getItems().get(0).getRequestId());
    }
    ...
    void toItemRequestSimplifiedDto_items_null_200_Test() {
        ...
        assertEquals(itemRequestSimplified.getRequester().getId(), itemRequestSimplifiedDto.getRequester().getId());
        assertEquals(itemRequestSimplified.getCreated(), itemRequestSimplifiedDto.getCreated());
        assertEquals(itemRequestSimplified.getItems(), itemRequestSimplifiedDto.getItems());
    }
}
