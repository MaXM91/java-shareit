...
public class BookingMapperTest {
    ...
    void toBookingRequestDtoTest() {
        ...
        BookingRequestDto bookingRequestDto = bookingMapper.toBookingRequestDto(booking1);
        ...
        assertEquals(booking1.getStatus(), bookingRequestDto.getStatus());
        assertEquals(booking1.getUser().getId(), bookingRequestDto.getBooker().getId());
        assertEquals(booking1.getItem().getId(), bookingRequestDto.getItem().getId());
        assertEquals(booking1.getItem().getName(), bookingRequestDto.getItem().getName());
    }
}
