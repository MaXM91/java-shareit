...
public class BookingControllerTests {
    ...
    private final BookingRequestDto bookingDtoAfter1 =
            new BookingRequestDto(1, start1, end1, StatusBooking.WAITING, null, null);
    @Autowired
    ObjectMapper mapper;
    @MockBean
    ...
    @Test
    void getBookingsByOwnerItemTest() throws Exception {
