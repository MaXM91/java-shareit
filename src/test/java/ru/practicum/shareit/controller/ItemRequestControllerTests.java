...
public class ItemRequestControllerTests {
    ...
    private final ItemRequestDto itemRequestDtoBefore1 = new ItemRequestDto(null,
            "description1", null, LocalDateTime.now().truncatedTo(ChronoUnit.SECONDS), null);
    private final ItemRequestDto itemRequestDtoAfter1 = new ItemRequestDto(1,
            "description1", null, itemRequestDtoBefore1.getCreated(), null);
