...
public class ItemStorageTest {
    ...
    void searchTest() {
        ...
        List<Item> actualItem = itemStorage.search("script", PageRequest.of(0 / 1, 1)).getContent();
    ...
    void findByOwnerIdTest() {
        ...
        List<Item> actualItem = itemStorage.findByOwnerId(savedUser.getId(), PageRequest.of(0 / 1, 1)).getContent();
