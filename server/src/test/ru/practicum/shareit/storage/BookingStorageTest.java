...
public class BookingStorageTest {
    ...
    void findAllByUserIdTest() {
        ...
        List<Booking> actualBooking =
                bookingStorage.findAllByUserId(actualUser2.getId(), PageRequest.of(0 / 1, 2)).getContent();
    ...
    void findByUserIdAndEndBeforeTest() {
        ...
        List<Booking> actualBooking =
                bookingStorage.findByUserIdAndEndBefore(actualUser3.getId(), LocalDateTime.now(),
                        PageRequest.of(0 / 1, 2)).getContent();
    ...
    void findByUserIdAndStartAfterTest() {
        ...
        List<Booking> actualBooking =
                bookingStorage.findByUserIdAndStartAfter(actualUser4.getId(), LocalDateTime.now(),
                        PageRequest.of(0 / 1, 2)).getContent();
    ...
    void findAllByItemOwnerIdTest() {
        ...
        List<Booking> actualBooking =
                bookingStorage.findAllByItemOwnerId(item7.getOwnerId(), PageRequest.of(0 / 1, 2)).getContent();
    ...
    void checkFreeDateBookingTest() {
        ...
        List<Booking> actualBooking =
                bookingStorage.checkFreeDateBooking(item11.getId(),
