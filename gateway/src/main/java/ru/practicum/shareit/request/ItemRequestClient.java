...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllYourItemRequest(Long userId) {
        return get("/", userId);
    }
    ...
    public ResponseEntity<Object> getAllItemRequestOtherUser(Long userId, Integer from, Integer size) {
